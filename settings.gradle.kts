...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            val quarkus = version("quarkus-plugin", quarkusVersion)
            ...
            library("quarkus-flyway", quarkusGroupId, "quarkus-flyway").withoutVersion()
            library("quarkus-hibernate-reactive-panache",
                    quarkusGroupId,
                    "quarkus-hibernate-reactive-panache").withoutVersion()
            library("quarkus-hibernate-validator", quarkusGroupId, "quarkus-hibernate-validator").withoutVersion()
            library("quarkus-jdbc-postgresql", quarkusGroupId, "quarkus-jdbc-postgresql").withoutVersion()
            library("quarkus-micrometer-registry-prometheus",
                    quarkusGroupId,
                    "quarkus-micrometer-registry-prometheus").withoutVersion()
            library("quarkus-reactive-pg-client", quarkusGroupId, "quarkus-reactive-pg-client").withoutVersion()
            library("quarkus-resteasy-reactive-jsonb",
                    quarkusGroupId,
                    "quarkus-resteasy-reactive-jsonb").withoutVersion()
            library("quarkus-resteasy-problem", "com.tietoevry.quarkus", "quarkus-resteasy-problem").versionRef(
                    quarkusResteasyProblem)
